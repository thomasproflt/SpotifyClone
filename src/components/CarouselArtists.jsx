...
const CarouselArtists = ({ data, setCurrentMusic }) => {
                ...
                >
                    {data.map((item) => (
                        <div key={item.id} className="min-w-[70%] sm:min-w-[45%] md:min-w-[20%] p-2 snap-start">
                            <div className="relative flex flex-col p-2 hover:bg-zinc-50/5 rounded-md group transition cursor-pointer">
                                <div className="w-45 h-45 overflow-hidden rounded-full mb-3">
                                    <img
                                        src={item.image}
                                        alt={item.band}
                                ...
                                <p className="text-center text-[14px] text-zinc-50 truncate">
                                    {item.band}
                                </p>
